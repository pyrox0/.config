...
#   "generate" "-f" "./lsfp/Cargo.toml" "-o" "../../.config/nix/crates/lsfp.nix"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "lsfp" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "lsfp"; path = "src/main.rs"; }
        ];
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ../../../software/crates/lsfp; };
        authors = [
          "The Noah <thenoahbz@gmail.com>"
        ];
        buildDependencies = [
          {
            name = "cc";
        ...
        resolvedDefaultFeatures = [ "color" "config" "default" "git" "icons" ];
      };
    };
